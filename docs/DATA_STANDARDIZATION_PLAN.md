...
### **[RC] Part 6 & 7 & Passage Group (20 Items - 한글화 완수)**
...
- `P6_CONNECTIVE`: **문맥 연결어구 판단** - 문장과 문장을 잇는 부사/접속사 등의 논리적 연결어 선택
...
- `P7_INTENTION`: **발화의도 정밀 분석** - 채팅/메시지 내 특정 어구(" ")의 문맥적 의도 파악
- `P7_LINK`: **다중지문 연계 추론** - 두 개 이상의 지문 정보를 결합하여 정답 도출 (Double/Triple 전용)
