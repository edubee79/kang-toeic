...
async function uploadActualTest2() {
    try {
        ...
        const filePath = path.join(process.cwd(), 'actual_test_2_pool.json');
        const questions = JSON.parse(fs.readFileSync(filePath, 'utf-8'));
        console.log(`🚀 Uploading ${questions.length} Actual Test 2 questions...`);
        ...
        console.log("🎉 Actual Test 2 questions uploaded successfully.");
        process.exit(0);
    } catch (error) {
