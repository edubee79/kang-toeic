...
async function uploadActualTest3() {
    try {
        ...
        const filePath = path.join(process.cwd(), 'actual_test_3_pool.json');
        const questions = JSON.parse(fs.readFileSync(filePath, 'utf-8'));
        console.log(`🚀 Uploading ${questions.length} Actual Test 3 questions...`);
        ...
        console.log("🎉 Actual Test 3 questions uploaded successfully.");
        process.exit(0);
    } catch (error) {
