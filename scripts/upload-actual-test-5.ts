...
async function uploadActualTest5() {
    try {
        ...
        const filePath = path.join(process.cwd(), 'actual_test_5_pool.json');
        const questions = JSON.parse(fs.readFileSync(filePath, 'utf-8'));
        console.log(`🚀 Uploading ${questions.length} Actual Test 5 questions...`);
        ...
        console.log("🎉 Actual Test 5 questions uploaded successfully.");
        process.exit(0);
    } catch (error) {
