...
async function uploadActualTest7() {
    try {
        ...
        const filePath = path.join(process.cwd(), 'actual_test_7_pool.json');
        const questions = JSON.parse(fs.readFileSync(filePath, 'utf-8'));
        console.log(`🚀 Uploading ${questions.length} Actual Test 7 questions...`);
        ...
        console.log("🎉 Actual Test 7 questions uploaded successfully.");
        process.exit(0);
    } catch (error) {
