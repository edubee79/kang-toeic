    ...
    useEffect(() => {
        ...
        const fetchAccess = async () => {
            ...
            if (userStr) {
                ...
                const units = Array.from({ length: 10 }, (_, i) => `LC_Part3_Test${i + 1}`);
                            ...
                            <Card className={cn(
                                ...
                                <div className="relative z-10 flex items-center justify-between w-full">
                                    ...
                                    <div className="shrink-0 pl-2 flex items-center gap-2">
                                        {test.isActive && completions[`LC_Part3_Test${test.id}`] && (
                                            <CompletionBadge
                                                completed={completions[`LC_Part3_Test${test.id}`].completed}
                                                score={completions[`LC_Part3_Test${test.id}`].score}
                                                total={completions[`LC_Part3_Test${test.id}`].total}
                                            />
                                        )}
                                        {!test.isActive ? (
