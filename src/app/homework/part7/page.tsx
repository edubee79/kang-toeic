...
import { part7TestData } from '@/data/rc_part7';
                ...
                <div className="space-y-6">
                    ...
                    <div>
                        ...
                        <p className="text-slate-400 font-medium text-lg">
                            Reading Comprehension (단일 지문 집중 훈련)
                        </p>
                    </div>
                            ...
                            >
                                <div className="flex flex-col sm:flex-row gap-6 items-start sm:items-center justify-between">
                                    <div className="space-y-1">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-xs font-bold text-slate-500">
                                                {test.sets.length} Sets • {test.sets.reduce((acc, p) => acc + p.questions.length, 0)} Questions
                                            </span>
                                        </div>
                                    ...
                                    <div className="flex gap-3 w-full sm:w-auto">
                                        <Link
                                            href={`/homework/part7/test/${test.testId}?mode=drill`}
                                        ...
                                        <Link
                                            href={`/homework/part7/test/${test.testId}?mode=real`}
