...
export default function LC_Full_Template({ onFinish }: Props) {
    ...
    const nextSpread = () => {
        if (currentSpread < totalSpreads - 1) {
            ...
            if (window.confirm("Finish the Listening Test and proceed to Reading?")) {
                onFinish();
            }
        }
    };
                ...
                <>
                    ...
                    <div className="footer">
                        ...
                        <div className="footer-center">
                            ...
                            <button className="nav-btn" onClick={nextSpread} style={{ background: '#007bff', borderColor: '#007bff' }}>
                                {currentSpread === totalSpreads - 1 ? 'PROCEED TO READING' : 'NEXT'}
                            </button>
                        </div>
                        <div className="footer-right" id="timer">LC PART</div>
                    </div>
                </>
            )}
        </>
