...
import OMRPanel from "@/components/exam/OMRPanel";
...
export default function RC_ExamTemplate({ onFinish }: Props) {
    ...
    const nextSpread = () => {
        if (currentSpread < totalSpreads - 1) {
            ...
            // End of RC test
            if (window.confirm("Finish the test?")) {
                onFinish();
            }
        }
    };
            ...
            <div className="page-row-content">
                        ...
                        <div key={i} className="question-set">
                            <div className="q-item">
                                ...
                                <div className="q-body">
                                    <span className="q-text">The management team ______ making a final decision until next week.</span>
                                    <div className="options">
                                        <label className="opt">(A) is delaying</label>
                                        <label className="opt">(B) delay</label>
                                        <label className="opt">(C) are delayed</label>
                                        <label className="opt">(D) have delayed</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="sub-col">
                    {Array.from({ length: 4 }, (_, i) => (
                        <div key={i} className="question-set">
                            <div className="q-item">
                                <div className="q-num">{startQ + 4 + i}.</div>
                                <div className="q-body">
                                    <span className="q-text">Please ______ the attached document for further details regarding the project proposal.</span>
                                    <div className="options">
                                        <label className="opt">(A) review</label>
                                        <label className="opt">(B) reviewing</label>
                                        <label className="opt">(C) reviewer</label>
                                        <label className="opt">(D) reviews</label>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div className="page-row-content">
                    ...
                    {Array.from({ length: 6 }, (_, i) => (
                        <div key={i} className="question-set">
                            <div className="q-item">
                                <div className="q-num">{startQ + i}.</div>
                                <div className="q-body">
                                    <span className="q-text">All employees are required ______ the safety training session.</span>
                                    <div className="options">
                                        <label className="opt">(A) to attend</label>
                                        <label className="opt">(B) attending</label>
                                        <label className="opt">(C) attend</label>
                                        <label className="opt">(D) attendance</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="sub-col">
                    {Array.from({ length: 6 }, (_, i) => (
                        <div key={i} className="question-set">
                            <div className="q-item">
                                <div className="q-num">{startQ + 6 + i}.</div>
                                <div className="q-body">
                                    <span className="q-text">The new software is significantly ______ than the previous version.</span>
                                    <div className="options">
                                        <label className="opt">(A) fast</label>
                                        <label className="opt">(B) faster</label>
                                        <label className="opt">(C) fastest</label>
                                        <label className="opt">(D) fasting</label>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div className="page-row-content">
                ...
                <div className="sub-col">
                    {Array.from({ length: 5 }, (_, i) => (
                        <div key={i} className="question-set">
                            <div className="q-item">
                                <div className="q-num">{startQ + 5 + i}.</div>
                                <div className="q-body">
                                    <span className="q-text">Please ______ the attached document for further details regarding the project proposal.</span>
                                    <div className="options">
                                        <label className="opt">(A) review</label>
    ...
    // --- PART 6 RENDERER ---
    const renderPart6StartPage = (startQ: number) => (
        <div className="page">
            <div className="directions-box">
            ...
            <div style={{ fontWeight: 'bold', marginBottom: '10px', fontSize: '14.5px' }}>
                Questions {startQ}-{startQ + 3} refer to the following e-mail.
            </div>

            <div style={{ border: '1px solid #ddd', padding: '20px', background: '#fdfdfd', marginBottom: '20px', fontSize: '15px', lineHeight: '1.8' }}>
                To: Marketing Team<br />
                From: Jennifer Park, Director<br />
                Date: March 10<br />
                Subject: Upcoming Product Launch<br /><br />

                Dear Team,<br /><br />
                I am pleased to announce that our new product line will be launching next month. We have been working --- {startQ} --- on this project for over a year, and I believe we are ready for a successful launch.<br /><br />
                The launch event will take place on April 15 at our headquarters. --- {startQ + 1} --- Please RSVP by April 1 so we can finalize catering arrangements.<br /><br />
                In preparation for the launch, each department should --- {startQ + 2} --- their marketing materials to me by March 25. This will ensure we have everything ready for the big day.<br /><br />
                Thank you for your --- {startQ + 3} --- to this important project.<br /><br />
                Best regards,<br />
                Jennifer Park
            </div>
                    ...
                    {Array.from({ length: 2 }, (_, i) => (
                        <div key={i} className="question-set">
                            <div className="q-item">
                                ...
                                <div className="q-body">
                                    <div className="options">
                                        <label className="opt">(A) diligent</label>
                                        <label className="opt">(B) diligence</label>
                                        <label className="opt">(C) diligently</label>
                                        <label className="opt">(D) more diligent</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    {Array.from({ length: 2 }, (_, i) => (
                        <div key={i} className="question-set">
                            <div className="q-item">
                                ...
                                <div className="q-body">
                                    <div className="options">
                                        <label className="opt">(A) submit</label>
                                        <label className="opt">(B) submits</label>
                                        <label className="opt">(C) submitted</label>
                                        <label className="opt">(D) submitting</label>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    const renderPart6Page = (startQ: number) => (
        <div className="page">
            <div style={{ fontWeight: 'bold', marginBottom: '10px', fontSize: '14.5px', marginTop: '20px' }}>
                Questions {startQ}-{startQ + 3} refer to the following letter.
            </div>
            ...
            <div style={{ border: '1px solid #ddd', padding: '20px', background: '#fdfdfd', marginBottom: '20px', fontSize: '15px', lineHeight: '1.8' }}>
                ...
                Date: April 5<br />
                Re: Road Maintenance<br /><br />

                This notice is to inform you that road maintenance work will begin on Main Street next week. The project is expected to take approximately three weeks to --- {startQ} ---.<br /><br />
                During this time, traffic will be diverted to side streets. We apologize for any inconvenience this may --- {startQ + 1} ---.<br /><br />
                Please note that street parking will be prohibited during construction hours. Vehicles left on the street will be --- {startQ + 2} --- at the owner's expense.<br /><br />
                We appreciate your --- {startQ + 3} --- and understanding as we improve our city's infrastructure.
            </div>
                    ...
                    {Array.from({ length: 2 }, (_, i) => (
                        <div key={i} className="question-set">
                            <div className="q-item">
                                ...
                                <div className="q-body">
                                    <div className="options">
                                        <label className="opt">(A) complete</label>
                                        <label className="opt">(B) completion</label>
                                        <label className="opt">(C) completed</label>
                                        <label className="opt">(D) completely</label>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    {Array.from({ length: 2 }, (_, i) => (
                        <div key={i} className="question-set">
                            <div className="q-item">
                                ...
                                <div className="q-body">
                                    <div className="options">
                                        <label className="opt">(A) cause</label>
                                        <label className="opt">(B) caused</label>
                                        <label className="opt">(C) causing</label>
                                        <label className="opt">(D) causes</label>
                                    </div>
                                </div>
                            </div>
                        </div>
