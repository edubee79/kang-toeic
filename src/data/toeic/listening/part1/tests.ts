        ...
        questions: [
            {
                ...
                script: {
                    ...
                    translation_B: "남자가 가구를 들어어올리고 있다.",
                    translation_C: "남자가 엔진에 시동을 걸고 있다.",
            ...
            },
            {
                ...
                script: {
                    ...
                    translation_C: "사람들이 책상 주위에 모여 있다.",
            ...
            },
            {
                ...
                script: {
                    ...
                    translation_A: "여성 중 한 명이 가방 안에 손을 넣고 있다.",
            ...
            },
            {
                ...
                script: {
                    ...
                    translation_C: "이동식 식품 판매대가 보도 위에 있다.",
        ...
        questions: [
            {
                ...
                script: {
                    ...
                    translation_B: "남자가 세탁물 운반차를 들여다보고 있다.",
            ...
            },
            {
                ...
                script: {
                    ...
                    translation_D: "여자들 중 한 명이 안경을 쓰고 있다."
                }
            },
            {
                id: "p1-t2-q3",
                ...
                script: {
                    ...
                    translation_C: "She is holding up some fruit. (여자가 과일을 들고 있다.)",
            ...
            },
            {
                ...
                script: {
                    ...
                    translation_C: "정원이 건물 밖에 식물들로 가꿔져 있다.",
            ...
            },
            {
                ...
                script: {
                    ...
                    translation_A: "의자들이 구석에 놓여 있다.",
                    translation_B: "조명 기구들이 벽면에 설치되어 있다.",
            ...
            },
            {
                ...
                script: {
                    ...
                    translation_C: "직원들 중 한 명이 가비를 들고 있다.",
        ...
        questions: [
            {
                ...
                script: {
                    ...
                    translation_A: "남자가 통 위로 몸을 숙리고 있다.",
            ...
            },
            {
                ...
                script: {
                    ...
                    translation_A: "고객이 세탁소에서 옷을 찾고 있다.",
                    translation_B: "손님이 재킷을 입어보고 있다.",
                    translation_C: "손님이 직원에게 현금을 건네고 있다.",
            ...
            },
            {
                ...
                script: {
                    ...
                    translation_A: "여자가 식사비를 계산하고 있다.",
                    translation_B: "여자가 음료를 따르고 있다.",
                    translation_C: "여자가 냉장 진열장을 마주보고 있다.",
                    translation_D: "여자가 웨이터에게 점심을 주문하고 있다."
                }
            },
            {
                id: "p1-t3-q4",
                ...
                script: {
                    ...
                    translation_A: "남자가 봉투에 채소를 넣고 있다.",
                    translation_B: "남자가 텐트를 치고 있다.",
                    translation_C: "승합차의 뒷문이 열려 있다.",
                    translation_D: "상자들이 차량 안에 보관되어 있다."
                }
            },
            {
                id: "p1-t3-q5",
                ...
                script: {
                    ...
                    translation_C: "여성 중 한 명이 영상을 보고 있다.",
                    translation_D: "여성 중 한 명이 안경을 고쳐 쓰고 있다."
                }
            },
            {
                id: "p1-t3-q6",
                ...
                script: {
                    ...
                    translation_D: "조명 기구가 식탁 공간 위에 걸려 있다."
                }
            }
        ]
    },
        ...
        questions: [
            ...
            },
            {
                ...
                script: {
                    ...
                    translation_B: "남자가 여행용 가방의 지퍼를 열고 있다.",
                    translation_C: "남자가 쿠션을 줍고 있다.",
                    translation_D: "남자가 병째로 마시고 있다."
                }
            },
            {
                id: "p1-t4-q3",
                ...
                script: {
                    ...
                    translation_B: "작업자들이 승강장을 짓고 있다.",
                    translation_C: "공연자들이 무대 위에 있다.",
                    translation_D: "음악가들이 장비를 풀고 있다."
                }
            },
            {
                id: "p1-t4-q4",
                ...
                script: {
                    ...
                    translation_C: "노트북 컴퓨터가 치워지고 있다.",
            ...
            },
            {
                ...
                script: {
                    ...
                    translation_A: "발표자가 창문을 닫고 있다.",
                    translation_B: "청중이 연단 뒤에 서 있다.",
                    translation_C: "청중이 스크린을 마주보고 있다.",
            ...
            },
            {
                ...
                script: {
                    ...
                    translation_A: "승객 몇몇이 보도에서 기다리고 있다.",
                    translation_B: "자전거 몇 대가 버스에 탑재되어 있다.",
        ...
        questions: [
            ...
            },
            {
                ...
                script: {
                    ...
                    translation_D: "여자들 중 한 명이 커피 컵으로 마시고 있다."
                }
            },
            {
                id: "p1-t5-q3",
                ...
                script: {
                    ...
                    translation_A: "남자들 중 한 명이 비닐봉지를 비우고 있다.",
                    translation_B: "사람들이 계산대에서 줄을 서서 기다리고 있다.",
                    translation_C: "남자를 중 한 명이 꽃들을 가리키고 있다.",
            ...
            },
            {
                ...
                script: {
                    ...
                    translation_C: "작업대에서 수납장 몇 개가 열려 있다.",
            ...
            },
            {
                ...
                script: {
                    ...
                    translation_A: "주택에서 낚시 부두가 내려다보인다.",
            ...
            },
            {
                ...
                script: {
                    ...
                    C: "One of the women is wearing a scarf around her neck.",
                    D: "One of the women is standing in the doorway.",
                    translation_A: "여자들 중 한 명이 여행 가방을 들고 있다.",
                    translation_B: "여자들 중 한 명이 겨드랑이에 노트를 끼고 있다.",
                    translation_C: "여자들 중 한 명이 목에 스카프를 두르고 있다.",
                    translation_D: "여자들 중 한 명이 문간에 서 있다."
                }
            }
        ]
    },
        ...
        questions: [
            {
                ...
                script: {
                    ...
                    translation_C: "여자가 당근을 한 움큼 움켜쥐고 있다.",
            ...
            },
            {
                ...
                script: {
                    ...
                    translation_D: "남자가 삽으로 시멘트를 펴 바르고 있다."
                }
            },
            {
                id: "p1-t6-q5",
        ...
        questions: [
            {
                ...
                script: {
                    ...
                    translation_A: "여자가 선풍기 플러그를 꽂고 있다.",
                    translation_B: "여자가 장비를 챙기고 있다.",
                    translation_C: "여자가 신발 끈을 묶으려고 몸을 굽히고 있다.",
            ...
            },
            {
                ...
                script: {
                    ...
                    translation_D: "사람들이 차량 문을 열고 있다."
                }
            },
            {
                id: "p1-t7-q3",
                ...
                script: {
                    ...
                    translation_C: "사람들이 집에 지붕을 시공하고 있다.",
            ...
            },
            {
                ...
                script: {
                    ...
                    translation_A: "베개들이 침대 위에 놓여 있다.",
                    translation_B: "램프들이 천장에 매달려 있다.",
            ...
            },
            {
                ...
                script: {
                    ...
                    translation_B: "호수가 내려다보이는 데크가 하나 있다.",
        ...
        questions: [
            {
                ...
                script: {
                    ...
                    translation_C: "여성 중 한 명이 음식을 서빙하고 있다.",
            ...
            },
            {
                ...
                script: {
                    ...
                    translation_A: "남자들이 마주 보고 있다.",
                    translation_B: "남자들이 길을 건너고 있다.",
                    translation_C: "남자들이 보도에 멈춰 서 있다.",
                    translation_D: "남자들이 여행 가방을 열어 놓고 있다."
                }
            },
            {
                id: "p1-t8-q5",
                ...
                script: {
                    ...
                    translation_A: "나뭇잎 더미가 한데 쓸려 있다.",
                    translation_B: "가구들이 울타리 근처에 쌓여 있다.",
                    translation_C: "우산 하나가 땅에 떨어져 있다.",
                    translation_D: "자전거가 기둥에 사슬로 묶여 있다."
                }
            },
            {
                id: "p1-t8-q6",
        ...
        questions: [
            {
                ...
                script: {
                    ...
                    translation_A: "남자가 천 앞치마를 풀고 있다.",
                    translation_B: "남자가 선반에 플라스틱 통을 놓고 있다.",
                    translation_C: "남자가 칼을 써서 음식을 썰고 있다.",
            ...
            },
            {
                ...
                script: {
                    ...
                    translation_A: "여자가 선글라스를 고쳐 쓰고 있다.",
                    translation_B: "여자가 벤치에 앉아 있다.",
                    translation_C: "여자가 핸드백 안으로 손을 뻗고 있다.",
            ...
            },
            {
                ...
                script: {
                    ...
                    translation_A: "여성 중 한 명이 쓰레기통 위로 몸을 숙이고 있다.",
                    translation_B: "여성 중 한 명이 게시판에 붙은 게시물을 보고 있다.",
                    translation_C: "여성 중 한 명이 입구 옆에 서 있다.",
                    translation_D: "여성 중 한 명이 기계에서 나온 돈을 세고 있다."
                }
            },
            {
                id: "p1-t9-q4",
                ...
                script: {
                    ...
                    translation_A: "차 한 대가 건물 옆에 주차되어 있다.",
                    translation_B: "문 하나가 열린 채 고정되어 있다.",
                    translation_C: "울타리에 표지판 하나가 게시되어 있다.",
                    translation_D: "식물들이 일렬로 배열되어 있다."
                }
            },
            {
                id: "p1-t9-q5",
            ...
            },
            {
                ...
                script: {
                    ...
                    translation_B: "장비가 트럭에 기대어 있다.",
                    translation_C: "남자가 눈밭에서 차를 몰고 있다.",
        ...
        questions: [
            {
                ...
                script: {
                    ...
                    translation_B: "남자가 구내식당에서 음식을 가져가고 있다.",
            ...
            },
            {
                ...
                script: {
                    ...
                    translation_A: "남자가 지도 위의 지점을 가리키고 있다.",
            ...
            },
            {
                ...
                script: {
                    ...
                    translation_C: "여자가 겨드랑이에 돌돌 만 매트를 끼고 있다.",
            ...
            },
            {
                ...
                script: {
                    ...
                    translation_A: "식탁용 집기 세트들이 냅킨 위에 정리되어 있다.",
            ...
            },
            {
                ...
                script: {
                    ...
                    translation_D: "사람들 중 한 명이 상자를 들어올리고 있다."
                }
            }
        ]
    }
