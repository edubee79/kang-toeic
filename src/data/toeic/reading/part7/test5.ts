            ...
            passages: [
                {
                    ...
                    title: "Owl and Moon Advertisement",
        ...
        // Questions 168-171: E-mail
        {
            ...
            questions: [
                ...
                },
                {
                    ...
                    explanation: `주어진 문장에서 '답변을 통해 고객의 취향과 요구사항을 파악한다'고 했으므로, 주어진 문장 앞에는 고객이 온라인 설문지 등을 통해 질문에 답변하는 내용(The first step is completing an online questionnaire)이 와야 흐름상 자연스럽습니다.`
                }
            ]
        },
        // Questions 172-175: Text Message Chain
        {
            ...
            questions: [
                ...
                },
                {
                    id: "p7-t5-q173",
                    questionNo: 173,
                    text: "What most likely cost about $30?",
                    classification: "P7_DETAIL",
                    options: {
                ...
                },
                {
                    id: "p7-t5-q174",
                    questionNo: 174,
                    text: "At 11:21 A.M., what does Ms. Clarke imply when she writes, \"That much?\"",
                    classification: "P7_INTENTION",
                    options: {
