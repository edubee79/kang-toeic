...
export const test1Data: Part5TestSet = {
    ...
    "questions": [
        ...
        },
        {
            ...
            "explanation": "빈칸은 동사 will be making의 목적어 명사 자리로, make와 함께 '배달하다'라는 의미을 완성하는 명사 (A) deliveries가 정답이다. (B) delivered는 동사/과거분사, (C) deliver는 동사이고, 형용사나 명사로 쓰이는 (D) deliverable은 명사인 경우 가산 단수명사로 앞에 한정사 없이 쓸 수 없으므로 빈칸에 들어갈 수 없다."
        },
        {
            "id": "v4-p5-t1-q112",
            "questionNo": 112,
