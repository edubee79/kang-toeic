...
export const test7Data: Part5TestSet = {
    ...
    "questions": [
        ...
        },
        {
            "id": "v4-p5-t7-q106",
            "questionNo": 106,
            "text": "The committee expects to be finished with the negotiations _____ 4:00 科.?.",
            "options": {
                "A": "over",
                "B": "until",
                "C": "on",
        ...
        },
        {
            "id": "v4-p5-t7-q110",
            "questionNo": 110,
            "text": "To _____ the status of your delivery, select the Track Order option in the drop-down menu.",
            "options": {
                "A": "place",
                "B": "want",
                "C": "check",
            ...
            "explanation": "to부정사의 목적어로 '배송 상태(the status of your delivery)'를 취하여 '~을 확인하다'라는 의미가 되어야 자연스럽다. 따라서 '확인하다'라는 뜻의 (C) check가 정답이다."
        },
        {
            "id": "v4-p5-t7-q111",
            "questionNo": 111,
        ...
        },
        {
            "id": "v4-p5-t7-q113",
            "questionNo": 113,
            "text": "Brighten up your desk with beautiful paper products from Norimi Stationery.",
            "options": {
                "A": "Brightens",
                "B": "Brighten",
                "C": "Brightened",
            ...
            "vol": 4,
            "correctAnswer": "B",
            "translation": "노리미 문구점의 아름다운 종이 제품들로 책상을 환하게 꾸며보세요.",
            "explanation": "문장에 주어가 없고 동사로 시작하는 명령문 자리이다. 따라서 동사 원형인 (B) Brighten이 정답이다. (Brighten up: ~을 밝게 하다/꾸미다)"
        },
        {
            "id": "v4-p5-t7-q114",
            "questionNo": 114,
        ...
        },
        {
            "id": "v4-p5-t7-q116",
            "questionNo": 116,
            "text": "Customers are _______ anticipating the latest model pickup truck from Askio Automobiles.",
            "options": {
                "A": "eagerly",
                "B": "sharply",
                "C": "voluntarily",
        ...
        },
        {
            "id": "v4-p5-t7-q117",
            "questionNo": 117,
            "text": "Once you have Mr. Garcia's _______, please post the job listing to the usual Web sites.",
            "options": {
                "A": "approve",
                "B": "approves",
                "C": "approval",
        ...
        },
        {
            "id": "v4-p5-t7-q118",
            "questionNo": 118,
            "text": "Dabby's Restaurant broadened its customer base by making _______ changes to its menu.",
            "options": {
                "A": "extensive",
                "B": "precious",
                "C": "commercial",
        ...
        },
        {
            "id": "v4-p5-t7-q119",
            "questionNo": 119,
            "text": "The redesigned intersection _______ shortens the street-crossing distance for pedestrians, making it safer.",
            "options": {
                "A": "effectively",
                "B": "effects",
                "C": "effective",
        ...
        },
        {
            "id": "v4-p5-t7-q120",
            "questionNo": 120,
            "text": "Workshop attendees are asked to _______ from asking questions until the end of the formal presentation.",
            "options": {
                "A": "refrain",
                "B": "forbid",
                "C": "retreat",
        ...
        },
        {
            "id": "v4-p5-t7-q121",
            "questionNo": 121,
            "text": "The Tamano Foundation accepts grant _______ related to a wide range of scientific research.",
            "options": {
                "A": "proposes",
                "B": "proposed",
                "C": "proposals",
        ...
        },
        {
            "id": "v4-p5-t7-q122",
            "questionNo": 122,
            "text": "Gateway Electronics will cancel any orders that have not been picked up _______ five days.",
            "options": {
                "A": "about",
                "B": "during",
                "C": "within",
        ...
        },
        {
            "id": "v4-p5-t7-q123",
            "questionNo": 123,
            "text": "_______ who arrives at the company parking garage after 10:00 A.M. must contact security for an access code.",
            "options": {
                "A": "Each",
                "B": "Those",
                "C": "Everything",
        ...
        },
        {
            "id": "v4-p5-t7-q124",
            "questionNo": 124,
            "text": "To get to the conference room, turn left _______ after passing the employee cafeteria.",
            "options": {
                "A": "immediately",
                "B": "recently",
                "C": "originally",
        ...
        },
        {
            "id": "v4-p5-t7-q125",
            "questionNo": 125,
            "text": "The wellness _______ at Trayer Media Group directly led to greater employee satisfaction with the company.",
            "options": {
                "A": "initiate",
                "B": "initiator",
                "C": "initiated",
        ...
        },
        {
            "id": "v4-p5-t7-q126",
            "questionNo": 126,
            "text": "We will keep producing our signature shoe designs _______ there is demand for them.",
            "options": {
                "A": "or else",
                "B": "as long as",
                "C": "as well as",
        ...
        },
        {
            "id": "v4-p5-t7-q127",
            "questionNo": 127,
            "text": "Regular applications of fertilizer improve seedling health and _______ enhance the growth of leafy vegetables.",
            "options": {
                "A": "drama",
                "B": "dramatic",
                "C": "dramatically",
        ...
        },
        {
            "id": "v4-p5-t7-q128",
            "questionNo": 128,
            "text": "Wantner Manufacturing received this year's Top Employer Award in _______ of its people-centered workplace environment.",
            "options": {
                "A": "service",
                "B": "accordance",
                "C": "recognition",
        ...
        },
        {
            "id": "v4-p5-t7-q129",
            "questionNo": 129,
            "text": "The editor noted some _______ content and marked the text to be deleted.",
            "options": {
                "A": "repetition",
                "B": "repetitious",
                "C": "repetitiously",
        ...
        },
        {
            "id": "v4-p5-t7-q130",
            "questionNo": 130,
            "text": "Bay City Zoo members get _______ access to members-only activities, such as after-hours guided tours.",
            "options": {
                "A": "exclusive",
                "B": "unknown",
                "C": "creative",
