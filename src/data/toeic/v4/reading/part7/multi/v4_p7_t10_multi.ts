...
export const test10MultiData: PracticeSet[] = [
        ...
        passages: [
            {
                ...
                docType: "ARTICLE",
                header: {
                    headline: "Business Profile: Rosier and Finch",
                    columns: 2
                },
                content: [
    ...
    // Questions 186-190: Triple Passage (Advertisement + Forum Post + Outline)
    {
        ...
        passages: [
            ...
            },
            {
                ...
                header: {
                    headline: "Popular Ice Cream Purveyor Comes to New Zealand",
                    author: "By Ysai Mendez",
                    columns: 2
                },
                content: [
        ...
        passages: [
            {
                ...
                header: {
                    headline: "Survey: Consumers Prefer Physical Stores",
                    columns: 2
                },
                content: [
